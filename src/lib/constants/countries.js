// Comprehensive countries dataset matching /walletmc/merchantportal/js/countries.js
export const COUNTRIES = [
  ...
  { name: "American Samoa", dial_code: "+1684", code: "AS", flag: "🇦🇸", part_of: ["US"] },
  { name: "Andorra", dial_code: "+376", code: "AD", flag: "🇦🇩", local_name: "Andorra" },
  { name: "Angola", dial_code: "+244", code: "AO", flag: "🇦🇴", local_name: "Angola" },
  { name: "Anguilla", dial_code: "+1264", code: "AI", flag: "🇦🇮", local_name: "Anguilla", part_of: ["GB"] },
  ...
  { name: "Bermuda", dial_code: "+1441", code: "BM", flag: "🇧🇲", part_of: ["GB"] },
  ...
  { name: "British Indian Ocean Territory", dial_code: "+246", code: "IO", flag: "🇮🇴", part_of: ["GB"] },
  ...
  { name: "Cayman Islands", dial_code: "+345", code: "KY", flag: "🇰🇾", part_of: ["GB"] },
  ...
  { name: "Christmas Island", dial_code: "+61", code: "CX", flag: "🇨🇽", part_of: ["AU"] },
  { name: "Cocos (Keeling) Islands", dial_code: "+61", code: "CC", flag: "🇨🇨", part_of: ["AU"] },
  ...
  { name: "Curaçao", dial_code: "+599", code: "CW", flag: "🇨🇼", part_of: ["NL"] },
  { name: "Cyprus", dial_code: "+357", code: "CY", flag: "🇨🇾" },
  { name: "Czechia", dial_code: "+420", code: "CZ", flag: "🇨🇿", local_name: "Česko" },
  { name: "Canary Islands", dial_code: "+34", code: "IC", flag: "🇮🇨", part_of: ["ES"] },
  ...
  { name: "Falkland Islands (Malvinas)", dial_code: "+500", code: "FK", flag: "🇫🇰", part_of: ["GB"] },
  { name: "Faroe Islands", dial_code: "+298", code: "FO", flag: "🇫🇴", part_of: ["DK"] },
  { name: "Fiji", dial_code: "+679", code: "FJ", flag: "🇫🇯" },
  { name: "Finland", dial_code: "+358", code: "FI", flag: "🇫🇮" },
  { name: "France", dial_code: "+33", code: "FR", flag: "🇫🇷" },
  { name: "French Guiana", dial_code: "+594", code: "GF", flag: "🇬🇫", part_of: ["FR"] },
  { name: "French Polynesia", dial_code: "+689", code: "PF", flag: "🇵🇫", part_of: ["FR"] },
  { name: "French Southern Territories", dial_code: "+262", code: "TF", flag: "🇹🇫", part_of: ["FR"] },
  ...
  { name: "Gibraltar", dial_code: "+350", code: "GI", flag: "🇬🇮", part_of: ["GB"] },
  { name: "Greece", dial_code: "+30", code: "GR", flag: "🇬🇷", local_name: "Ελλάς" },
  { name: "Greenland", dial_code: "+299", code: "GL", flag: "🇬🇱", part_of: ["DK"] },
  { name: "Grenada", dial_code: "+1473", code: "GD", flag: "🇬🇩" },
  { name: "Guadeloupe", dial_code: "+590", code: "GP", flag: "🇬🇵", part_of: ["FR"] },
  { name: "Guam", dial_code: "+1671", code: "GU", flag: "🇬🇺", part_of: ["US"] },
  { name: "Guatemala", dial_code: "+502", code: "GT", flag: "🇬🇹" },
  { name: "Guernsey", dial_code: "+44", code: "GG", flag: "🇬🇬", part_of: ["GB"] },
  ...
  { name: "Heard & McDonald Islands", dial_code: "+672", code: "HM", flag: "🇭🇲", part_of: ["AU"] },
  { name: "Holy See (Vatican City State)", dial_code: "+379", code: "VA", flag: "🇻🇦" },
  { name: "Honduras", dial_code: "+504", code: "HN", flag: "🇭🇳" },
  { name: "Hong Kong", dial_code: "+852", code: "HK", flag: "🇭🇰", local_name: "香港", part_of: ["CN"] },
  ...
  { name: "Iran, Islamic Republic of", dial_code: "+98", code: "IR", flag: "🇮🇷", local_name: "ایران" },
  { name: "Iraq", dial_code: "+964", code: "IQ", flag: "🇮🇶", local_name: "العراق" },
  { name: "Ireland", dial_code: "+353", code: "IE", flag: "🇮🇪", local_name: "Éire" },
  { name: "Isle of Man", dial_code: "+44", code: "IM", flag: "🇮🇲", part_of: ["GB"] },
  ...
  { name: "Lao People's Democratic Republic", dial_code: "+856", code: "LA", flag: "🇱🇦", local_name: "ປະເທດລາວ" },
  ...
  { name: "Martinique", dial_code: "+596", code: "MQ", flag: "🇲🇶", part_of: ["FR"] },
  { name: "Mauritania", dial_code: "+222", code: "MR", flag: "🇲🇷" },
  { name: "Mauritius", dial_code: "+230", code: "MU", flag: "🇲🇺" },
  { name: "Mayotte", dial_code: "+262", code: "YT", flag: "🇾🇹", part_of: ["FR"] },
  ...
  { name: "Caribbean Netherlands", dial_code: "+599", code: "BQ", flag: "🇧🇶", part_of: ["NL"] },
  { name: "New Caledonia", dial_code: "+687", code: "NC", flag: "🇳🇨", part_of: ["FR"] },
  ...
  { name: "Norfolk Island", dial_code: "+672", code: "NF", flag: "🇳🇫", part_of: ["AU"] },
  { name: "North Macedonia", dial_code: "+389", code: "MK", flag: "🇲🇰" },
  { name: "Northern Mariana Islands", dial_code: "+1670", code: "MP", flag: "🇲🇵", part_of: ["US"] },
  ...
  { name: "Palestine, State of", dial_code: "+970", code: "PS", flag: "🇵🇸" },
  ...
  { name: "Pitcairn", dial_code: "+872", code: "PN", flag: "🇵🇳", part_of: ["GB"] },
  { name: "Poland", dial_code: "+48", code: "PL", flag: "🇵🇱" },
  { name: "Portugal", dial_code: "+351", code: "PT", flag: "🇵🇹" },
  { name: "Puerto Rico", dial_code: "+1939", code: "PR", flag: "🇵🇷", country_code: "+1", area_codes: ["939", "787"], part_of: ["US"] },
  ...
  { name: "Réunion", dial_code: "+262", code: "RE", flag: "🇷🇪", part_of: ["FR"] },
  { name: "Saint Barthélemy", dial_code: "+590", code: "BL", flag: "🇧🇱", part_of: ["FR"] },
  { name: "Saint Helena, Ascension and Tristan Da Cunha", dial_code: "+290", code: "SH", flag: "🇸🇭", part_of: ["GB"] },
  { name: "Saint Kitts and Nevis", dial_code: "+1869", code: "KN", flag: "🇰🇳" },
  { name: "Saint Lucia", dial_code: "+1758", code: "LC", flag: "🇱🇨" },
  { name: "Saint Martin", dial_code: "+590", code: "MF", flag: "🇲🇫", part_of: ["FR"] },
  { name: "Saint Pierre and Miquelon", dial_code: "+508", code: "PM", flag: "🇵🇲", part_of: ["FR"] },
  ...
  { name: "Sint Maarten", dial_code: "+1721", code: "SX", flag: "🇸🇽", part_of: ["NL"] },
  ...
  { name: "South Georgia and the South Sandwich Islands", dial_code: "+500", code: "GS", flag: "🇬🇸", part_of: ["GB"] },
  { name: "South Sudan", dial_code: "+211", code: "SS", flag: "🇸🇸" },
  { name: "Spain", dial_code: "+34", code: "ES", flag: "🇪🇸" },
  { name: "Sri Lanka", dial_code: "+94", code: "LK", flag: "🇱🇰", local_name: "ශ්රී ලංකාව" },
  { name: "Sudan", dial_code: "+249", code: "SD", flag: "🇸🇩", local_name: "السودان" },
  { name: "Suriname", dial_code: "+597", code: "SR", flag: "🇸🇷" },
  { name: "Svalbard and Jan Mayen", dial_code: "+47", code: "SJ", flag: "🇸🇯", part_of: ["NO"] },
  ...
  { name: "Turkey", dial_code: "+90", code: "TR", flag: "🇹🇷", local_name: "Türkiye" },
  { name: "Turkmenistan", dial_code: "+993", code: "TM", flag: "🇹🇲" },
  { name: "Turks and Caicos Islands", dial_code: "+1649", code: "TC", flag: "🇹🇨", part_of: ["GB"] },
  ...
  { name: "Virgin Islands, British", dial_code: "+1284", code: "VG", flag: "🇻🇬", part_of: ["GB"] },
  { name: "Virgin Islands, U.S.", dial_code: "+1340", code: "VI", flag: "🇻🇮", part_of: ["US"] },
  ...
  { name: "Åland Islands", dial_code: "+358", code: "AX", flag: "🇦🇽", part_of: ["FI"] }
];

// Helper to format country array for input selectors
export const COUNTRY_OPTIONS = COUNTRIES.map((c) => ({
  code: c.dial_code.replace("+", ""),
  dialCode: c.dial_code,
  flag: c.flag,
  name: c.name,
  country: `${c.name} (${c.dial_code})`,
  isoCode: c.code,
}));
