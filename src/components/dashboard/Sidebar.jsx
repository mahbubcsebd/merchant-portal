...
export function Sidebar({ isCollapsed, setIsCollapsed, isMobile, onClose }) {
  ...
  const MENU_ITEMS = [
    ...
    {
      label: t("manage_cashiers", "Manage Cashiers"),
      href: "/dashboard/manage-cashiers",
      icon: Users,
    },
    {
    ...
    {
      label: t("pay_bills", "Pay Bills"),
      href: "/dashboard/pay-bills",
      icon: CreditCard,
    },
    {
      label: t("transfer_to_bank", "Transfer To Bank"),
      ...
      <div className="relative z-20 flex-shrink-0 bg-white dark:bg-[#0f1829] pb-2 border-b border-slate-200/60 dark:border-white/5">
        ...
        <div
          className={cn(
            ...
            isCollapsed
              ? "justify-center mt-3 mx-auto"
              : "gap-3 px-6 py-3.5 mt-1",
          )}
        >
