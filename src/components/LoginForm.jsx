...
const getFormSchema = (t) =>
  z.object({
    email: z
      .string()
      .min(1, {
        message: t("usernameRequired", "User ID / Email Address is required."),
      })
      .email({
    ...
    pin: z
      ...
      .length(6, {
        message: t("pin_digit_error", "Wallet PIN must be exactly 6 digits."),
      })
      .regex(/^[0-9]+$/, {
        message: t(
          "pin_numeric_error",
          "Wallet PIN must contain numbers only.",
        ),
      }),
  });
    ...
    <div className="w-full">
      ...
      <div className="mb-8 xl:mb-10 animate-[fade-up_0.4s_ease-out_both]">
        <h2 className="text-3xl sm:text-4xl lg:text-3xl xl:text-4xl font-bold tracking-tight text-slate-900 dark:text-white leading-[1.1]">
          {t(
            "authenticateTitle",
            t("wallet_pin_login", t("welcome_back", "Welcome back")),
          )}
        </h2>
